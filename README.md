# แปลเกมส์เป็นภาษาไทยแบบเรียลไทม์ด้วยโปรแกรม PCOT [Draft 2023/08/02]
...
### การแปลภาษาแบบ Free Selection
 ...
 - บางครั้ง OCR จะแปลงข้อความบรรทัดต่อบรรทัดทำให้การแปลภาษาไม่ต่อเนื่อง เราสามารถติ๊กถูกที่ **"改行を無視 (Ignore newlines)"** ทางด้านบนเพื่อรวมข้อความให้เป็นบรรทัดเดียวกันแล้วกดปุ่ม **"再翻訳 (Retranslation)"** เพื่อแปลข้อความใหม่อีกครั้ง
