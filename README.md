...
ปรับปรุงล่าสุด: 2 ส.ค. 2566
 ...
 - [การใช้งาน PCOT](#การใช้งาน-pcot)
   ...
   - [การแปลภาษาแบบ Fixed Selection](#การแปลภาษาแบบ-fixed-selection)
...
ในการใช้งาน PCOT คุณ Nuruppo มีคำแนะนำให้ดังนี้
 - ใช้งานบนจอภาพหลัก (main display) ไม่แนะนำให้ใช้งานบนจอภาพภายนอก (external displays)
 - ใช้งานแบบหน้าต่าง (windows mode) ไม่แนะนำให้ใช้งานแบบเต็มหน้าจอ (fullscreen mode)
...
### การแปลภาษาแบบ Free Selection
 ...
 - PCOT จะทำการอ่านภาษาต้นฉบับจากรูปภาพในเกมแล้วแปลงออกมาเป็นตัวอักษร (OCR) ลงในช่องด้านบน และทำการแปลภาษา (Translate) ลงในช่องด้านล่าง
 ...
 - จากรูปด้านบนจะพบว่า Tesseract OCR แปลงตัวอักษรผิดพลาด จากตัว **"I"** เป็นเลข **"1"** เราสามารถแก้ไขข้อความ OCR ให้ถูกต้องแล้วกดปุ่ม **"再翻訳 (Retranslation)"** เพื่อแปลข้อความใหม่อีกครั้ง
 ...
 - บางครั้ง OCR จะแปลงข้อความบรรทัดต่อบรรทัดทำให้การแปลภาษาขาดความต่อเนื่อง เราสามารถติ๊กถูกที่ **"改行を無視 (Ignore newlines)"** ทางด้านบนให้รวมข้อความเป็นบรรทัดเดียวกันแล้วกดปุ่ม **"再翻訳 (Retranslation)"** เพื่อแปลข้อความใหม่อีกครั้ง
