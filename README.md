...
#### การตั้งค่าเริ่มต้น
 ...
 - ติ๊กถูกที่ **"範囲選択時に対象プロセスのスレッドを停止 (Stop the thread of the target process when selecting a range)"** เพื่อหยุดภาพบนหน้าจอของเกมระหว่างการใช้เมาส์ลากคลุมพื้นที่หน้าจอ ช่วยให้แปลงข้อความได้เร็วขึ้น โดยเฉพาะเกมที่ฉากหลังขยับไปมาด้วยความรวดเร็ว
...
ก่อนทำการเพิ่มภาษาสำหรับ Windows 10 OCR ผมขอบอกข้อจำกัดของ PCOT OCR ก็ตือ เราต้อง[เพิ่มภาษาสำหรับ Tesseract OCR](#การเพิ่มภาษาสำหรับ-tesseract-ocr) ก่อน จึงจะสามารถเลือกใช้งาน Windows 10 OCR ในภาษานั้น ๆ ได้ ถึงแม้เราจะไม่ต้องการใช้ Tesseract OCR ในภาษานั้นเลยก็ตาม

ยกตัวอย่างเช่น หากต้องการแปลภาษาญี่ปุ่น (Japanese) ก็ต้องเพิ่มภาษาสำหรับ Tesseract OCR เข้ามาก่อน แล้วค่อยเพิ่มภาษาสำหรับ Windows 10 OCR หากไม่เพิ่มภาษาสำหรับ Tesseract OCR เข้ามาก่อนก็จะไม่มี Japanese ให้เลือกในรายการภาษาต้นฉบับครับ
...
- ทางด้านบน ให้พิมพ์ชื่อภาษาที่ต้องการ
