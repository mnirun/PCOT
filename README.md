# แปลเกมเป็นภาษาไทยแบบเรียลไทม์ด้วยโปรแกรม PCOT [Draft 2023/08/03]
ปรับปรุงล่าสุด: 3 ส.ค. 2566
...
#### Image Processing ตัวอย่างที่ 2: ตัวอักษรสีใกล้เคียงกับพื้นหลัง
 ...
 - เมื่อไม่มีรายการประมวลภาพแล้วภาพด้านขวาจะกลับไปสู่ภาพต้นฉบับ ผมจะใช้เทคนิคการปรับความสว่างของภาพ "明度 (Brightness)" เพื่อแยกตัวอักษรออกจากพื้นหลัง เราสามารถปรับต่าความสว่างของภาพได้ตั้งแต่ 255 ~ -255 โดยปรับค่าไปทางบวกภาพจะสว่างขึ้นและปรับค่าไปทางลบภาพจะมืดลง ผมจะปรับค่าไปที่ -120 (กึ่งกลางระหว่าง 0 ~ -255 และเพื่อความรวดเร็วจะใช้ตัวเลขที่หาร 10 ลงตัวเท่านั้น)
 ...
 - ลองเปลี่ยนไปใช้เครื่องมือขยายภาพ **"倍率 (Magnification)"** ที่อยู่ในกลุ่ม **"OCR読取設定 (OCR scan settings)"** โดยปรับค่าไปที่ 2.5 แล้วกดปุ่ม **"OCRテスト (OCR test)"** 
