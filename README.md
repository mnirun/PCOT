...
- รันไฟล์ **"C:\Translator\PCOT\PCOT.exe"**
 ...
 - ที่หน้าต่าง **"固定翻訳タイトル設定 (Fixed translation title setting)"** ให้พิมพ์ชื่อเรื่องการแปลในช่องด้านขวา เช่น **"Conversation Text"** เป็นต้น

   <kbd>![PCOT_05_Fixed_Translation_02](Pictures/PCOT_05_Fixed_Translation_02.png)</kbd>
 - x
