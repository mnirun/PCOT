...
- รันไฟล์ **"C:\Translator\PCOT\PCOT.exe"**
 ...
 - หากต้องการแปลภาษาในพื้นที่หน้าจอที่ได้สร้างรายการไว้แล้ว เพียงแค่เลือกให้เลือกจากรายการ fixed translation แล้วกดปุ่ม **"翻訳 (Translation)"** PCOT ก็จะคลุมพื้นที่หน้าจอที่ต้องการแล้วแปลภาษาให้โดยอัตโนมัติ หรือจะกดแป้นพิมพ์ลัด <kbd>Ctrl</kbd> + <kbd>Shift</kbd> + <kbd>1</kbd> (1 = เลขลำดับรายกา fixed translation, สูงสุด 9 รายการ) ก็ได้เช่นกัน
